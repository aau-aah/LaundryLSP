                        ...
                        <form class="space-y-4 md:space-y-6" action="{{ route('transaction.store') }}" method="post">
                                    ...
                                    <select id="id_member" name="id_member" required
                                        ...
                                        @foreach ($members as $member)
                                            <option value="{{ $member->id }}"
                                                @if (old('id_member') == $member->id) {{ 'selected' }} @endif>
                                                {{ $member->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div>
                                <label for="biaya_tambahan"
                                    class="block mb-2 text-sm font-medium @error('biaya_tambahan') text-red-700 dark:text-red-500 @else text-gray-900 dark:text-white @enderror">
                                    Biaya Tambahan <span class="text-red-400">*</span>
                                </label>
                                <input required type="text" name="biaya_tambahan" id="biaya_tambahan"
                                    maxlength="11" value="{{ old('biaya_tambahan') }}"
                                    onkeypress="return /[0-9]/i.test(event.key)"
                                    class="rounded-lg block w-full p-2.5 sm:text-sm  @error('biaya_tambahan') bg-red-50 border border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500 dark:bg-red-100 dark:border-red-400 dark:placeholder-red-700 dark:text-red-900 @else bg-gray-50 border border-gray-300 text-gray-900 focus:ring-primary-600 focus:border-primary-600 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 @enderror"
